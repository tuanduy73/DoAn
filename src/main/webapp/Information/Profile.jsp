                    ...
                    <div class="col-md-6">
                        ...
                        <%} %>
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="Profile.jsp" role="tab" aria-controls="home" aria-selected="true">About</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="History.jsp" role="tab" aria-controls="profile" aria-selected="false">Timeline</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <a class="profile-edit-btn" href="Edit-Profile.jsp">Change Password</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <%
                        String sql3="SELECT*FROM DANGNHAP WHERE TEN = '" + Username + "'";         
