...
<div id="header"><header class="hero">
 ...
 <div class="container">
    ...
    <div class="row" id="detail">
			...
			<p class="detail__p pb-lg-4">900.000 <sup>$</sup></p>
			</c:forEach>
			...
			<a href="../WebJS/AddOrder/Order6.jsp">Thêm Vào Giỏ</a>
			</div>
			...
			<span class="tt mt-md-5 mt-4"><a href="../WebJS/AddOrder/Order6.jsp" style="color: black">Thanh Toán</a></span>
			</div>
			<div class="col-12">
