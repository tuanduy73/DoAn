...
<html lang="en"><head>
  ...
  <!-- Purchase Continue CSS -->
  <link rel="stylesheet" type="text/css" href="../css/purchaseContinue.css">
...
<body data-new-gr-c-s-check-loaded="14.1033.0" data-gr-ext-installed="">
 <%
  ...
  <!-- Main -->
  <div class="col-12 text-center tieude my-lg-4 py-lg-5 my-5">thông tin đơn hàng</div>

  <div class="container">

    <div class="row mb-md-5 mb-4">
      <div class="col-md-4 col-12">
        <a href="purchase.html"><img src="../css/images/thanhtoan.png" style="width: 100%;"></a>
      </div>

      <div class="col-md-8 col-12 mt-5 mt-md-0 khoithanhtoan">
        <p class="pb-3">phương thức thanh toán</p>
        <label><div class="btn btn-outline-dark" style="cursor: pointer;"><input type="radio" name="tt"><span class="khoithanhtoan__radio">thanh toán tại nhà</span></div></label> <br> 
        <label><div class="btn btn-outline-dark align__left" style="cursor: pointer;"><input type="radio" name="tt"><span class="khoithanhtoan__radio">thanh toán bằng thẻ (visa, ATM, Master Card...)</span></div></label>
        <p class="pt-5 pb-3">thông tin khách hàng</p>
        <input type="text" placeholder="Họ Và Tên" name="" required="" class="inputemail col-6 width">
        <input type="text" placeholder="Số Điện Thoại" name="" class="inputsdt col-6 width float-right" required=""> <br>
        <textarea placeholder="Địa Chỉ" rows="10%" class="col-12" required=""></textarea>
      </div>
    </div> <!-- het row -->
    ...
    <div class="row" id="sum"></div>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <a href="Previous-Payment.jsp"><span class="tt">thanh toán</span></a>
        </div>
      </div> <!-- het row -->

  </div> <!-- het container -->

  <div class="container-fluid pt-md-5 khoilhmh">
          ...
          <div class="col-7">
            <div class="row">
              <div class="col-6 purchase__lhmh--tk">
                BIDV: <br>
                CTK: Đỗ Duy Anh <br>
                STK: 0204 4988 201 <br>
                CN  : Thái Nguyên <br>
              </div>
              <div class="col-6 purchase__lhmh--tk">
                Vietcombank:  <br>
                CTK: Đỗ Tuấn Thanh <br>
                STK: 0204 4988 201 <br>
                CN  : Thái Nguyên <br>
              </div>
            </div>
				...
				<div class="col-lg-6 col-12">
					<div class="row">
						<div class="khoinoidung pl-md-5 pl-sm-4">
							<p class="text1">trần lan auto</p>
							<p class="text1--2 bold">Trần Lan cam kết nỗ lực hết mình 
							...
							<div class="addres my-4">
								...
								<span class="text1--2">580 đường bắc cạn, TP.Thái Nguyên, tỉnh Thái Nguyên</span>
							</div>
							<div class="mail my-4">
								<i class="fas fa-envelope"></i>
								<span class="text1--2">tranlanauto@gmail.com</span>
							</div>
