...
<body data-new-gr-c-s-check-loaded="14.1028.0" data-gr-ext-installed="">
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
					<ul class="navbar-nav ml-auto mt-2 mt-lg-0">
						...
						<li class="nav-item hoverheader">
							<a class="nav-link" href="Contacts.jsp">Liên lạc</a>
						</li>
						<li class="nav-item hoverheader">
						...
						<li class="nav-item hoverheader">
							<div class="dropdown">
							  ...
							  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							    <a class="dropdown-item" href="Sign.jsp">Login</a>
  ...
  <div class="gt">sản phẩm</div>

  <!-- Main -->
  <div class="container">

    <div class="row my-md-5 pt-md-5 mt-5">

      <div class="col-lg-3 col-sm-4 col-12 mb-sm-0 mb-4">
        <input class="search" type="text" name="search" placeholder="Tìm Kiếm ..."><i class="fas fa-search search1"></i>
      </div>
      <div class="col-lg-9 col-sm-8 col-12 text-md-right text-center mid">
        <span class="orderBy">sắp xếp theo</span>
        <button class="orderBy--choice--input orderBy--choice ascPrice sortCommon filter-press" data-sort-value="sortPrice">giá</button>
        <button class="orderBy--choice--input orderBy--choice ascAlphabet sortCommon filter-press" data-sort-value="sortName">bảng chữ cái</button>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-12 filtermid">
        <div class="row text-center product__list mt-lg-0 mt-5 filter mx-0">
          <div class="filter-all">Lọc Sản Phẩm</div>
          <button class="col-md-12 col-2 filter-press">Tất cả sản phẩm</button>
          <button class="col-md-12 col-2 product__list--hmv filter-press" data-filter=".de">
            Porsche
          </button>
          <button class="col-md-12 col-2 product__list--dcxh filter-press" data-filter=".qkn">
            Range Rover
          </button>
          <button class="col-md-12 col-2 product__list--nt filter-press" data-filter=".qgl">
            Mercedes
          </button>
          <button class="col-md-12 col-2 product__list--pk filter-press" data-filter=".mm">
            Audi
          </button>
          <button class="col-md-12 col-2 product__list--k filter-press" data-filter=".mp">
            Lamboghini
          </button> 
        </div> <!-- het row -->
      </div> <!-- het col-3 -->
      ...
      <div class="col-md-9 col-12">
        <div class="load row" id="content">
					<div class="col-6 col-lg-4 mb-5 qkn">
					<div class="card" style="height:100%">
					<a href="../Login-Previous-Payment/Login-Previous-Payment.jsp"><img src="../css/images/cayenne.png" class="card-img-top" alt="..."></a>
					<div class="card-body">
					<p class="card-text sortName">Porsche Cayenne</p>
					<p class="sortPrice">400.000 $</p> <br> <br>
					<a href="../Login-Previous-Payment/Login-Previous-Payment.jsp" class="btn btn-primary muangay" style="position:absolute;bottom :25px">Mua ngay</a>
					</div>
					</div>
					</div>
					<div class="col-6 col-lg-4 mb-5 qkn">
					<div class="card" style="height:100%">
					<a href="../Login-Previous-Payment/Login-Previous-Payment.jsp"><img src="../css/images/mercsdesBenz.png" class="card-img-top" alt="..."></a>
					<div class="card-body">
					<p class="card-text sortName">Mercedes Benz 2021</p>
					<p class="sortPrice">500.000 $</p> <br> <br>
					<a href="../Login-Previous-Payment/Login-Previous-Payment.jsp" class="btn btn-primary muangay" style="position:absolute;bottom :25px">Mua ngay</a>
					</div>
					</div>
					</div>
					<div class="col-6 col-lg-4 mb-5 qkn">
					<div class="card" style="height:100%">
					<a href="../Login-Previous-Payment/Login-Previous-Payment.jsp"><img src="../css/images/porsche911.jpg" class="card-img-top" alt="..."></a>
					<div class="card-body">
					<p class="card-text sortName">Porsche 911</p>
					<p class="sortPrice">600.000 $</p> <br> <br>
					<a href="../Login-Previous-Payment/Login-Previous-Payment.jsp" class="btn btn-primary muangay" style="position:absolute;bottom :25px">Mua ngay</a>
					</div>
					</div>
					</div>
					<div class="col-6 col-lg-4 mb-5 qgl">
					<div class="card" style="height:100%">
					<a href="../Login-Previous-Payment/Login-Previous-Payment.jsp"><img src="../css/images/porscheAG.png" class="card-img-top" alt="..."></a>
					<div class="card-body">
					<p class="card-text sortName">Porsche AG</p>
					<p class="sortPrice">700.000 $</p> <br> <br>
					<a href="../Login-Previous-Payment/Login-Previous-Payment.jsp" class="btn btn-primary muangay" style="position:absolute;bottom :25px">Mua ngay</a>
					</div>
					</div>
					</div>
					<div class="col-6 col-lg-4 mb-5 de">
					<div class="card" style="height:100%">
					<a href="../Login-Previous-Payment/Login-Previous-Payment.jsp"><img src="../css/images/RangeRover.jpg" class="card-img-top" alt="..."></a>
					<div class="card-body">
					<p class="card-text sortName">Range Rover</p>
					<p class="sortPrice">800.000 $</p> <br> <br>
					<a href="../Login-Previous-Payment/Login-Previous-Payment.jsp" class="btn btn-primary muangay" style="position:absolute;bottom :25px">Mua ngay</a>
					</div>
					</div>
					</div>
					<div class="col-6 col-lg-4 mb-5 de">
					<div class="card" style="height:100%">
					<a href="../Login-Previous-Payment/Login-Previous-Payment.jsp"><img src="../css/images/RangeRoverVelar.jpg" class="card-img-top" alt="..."></a>
					<div class="card-body">
					<p class="card-text sortName">Range Rover Velar</p>
					<p class="sortPrice">900.000 $</p> <br> <br>
					<a href="../Login-Previous-Payment/Login-Previous-Payment.jsp" class="btn btn-primary muangay" style="position:absolute;bottom :25px">Mua ngay</a>
					</div>
					</div>
					</div></div>
    ...
    <div class="row mb-5 pb-5">
      <div class="btn btn-primary xemthem my-md-5" id="xemthem">Xem Thêm</div>
    </div> <!-- het row -->
